# TEST: BK-18: TC11: should treat PATCH /atcs/{id} with an empty body as a 200 no-op without version bump or event

**Jira Key:** [BK-159](https://jira.upexgalaxy.com/browse/BK-159)
**Status:** Candidate
**Components:** None
