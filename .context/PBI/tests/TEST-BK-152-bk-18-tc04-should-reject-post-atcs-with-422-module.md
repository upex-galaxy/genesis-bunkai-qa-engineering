# TEST: BK-18: TC04: should reject POST /atcs with 422 module_outside_project_subtree when the module is outside the user story subtree

**Jira Key:** [BK-152](https://jira.upexgalaxy.com/browse/BK-152)
**Status:** Candidate
**Components:** None
