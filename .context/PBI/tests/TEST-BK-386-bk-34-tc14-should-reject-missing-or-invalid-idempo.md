# TEST: BK-34: TC14: should reject missing or invalid Idempotency-Key before Run creation given valid body

**Jira Key:** [BK-386](https://jira.upexgalaxy.com/browse/BK-386)
**Status:** Candidate
**Components:** None
