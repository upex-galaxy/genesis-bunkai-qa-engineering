# TEST: BK-34: TC06: should store executor mode for human, agent, and ci callers given PAT with run:execute

**Jira Key:** [BK-380](https://jira.upexgalaxy.com/browse/BK-380)
**Status:** Candidate
**Components:** None
