# TEST: BK-18: TC08: should return 200, bump version and cascade-replace children when PATCH /atcs/{id} full-replaces with X-If-Match (BK-96 regression)

**Jira Key:** [BK-156](https://jira.upexgalaxy.com/browse/BK-156)
**Status:** Candidate
**Components:** None
