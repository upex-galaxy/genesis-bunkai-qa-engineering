# TEST: BK-18: TC06: should enforce POST /atcs body boundaries for title length, step count, tag count and layer enum

**Jira Key:** [BK-154](https://jira.upexgalaxy.com/browse/BK-154)
**Status:** Candidate
**Components:** None
