# TEST: BK-34: TC11: should collapse duplicate click or retry with same Idempotency-Key and same payload given same caller

**Jira Key:** [BK-384](https://jira.upexgalaxy.com/browse/BK-384)
**Status:** Candidate
**Components:** None
