# TEST: BK-34: TC02: should reject Run start when Test has zero executable steps given executable Test required

**Jira Key:** [BK-376](https://jira.upexgalaxy.com/browse/BK-376)
**Status:** Candidate
**Components:** None
