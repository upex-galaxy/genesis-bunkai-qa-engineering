# TEST: BK-34: TC03: should reject Run start with Environment outside the Test Project given invalid environment

**Jira Key:** [BK-377](https://jira.upexgalaxy.com/browse/BK-377)
**Status:** Candidate
**Components:** None
