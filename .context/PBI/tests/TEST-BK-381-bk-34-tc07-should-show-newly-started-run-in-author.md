# TEST: BK-34: TC07: should show newly started Run in authorized Run history read surface given successful Run creation

**Jira Key:** [BK-381](https://jira.upexgalaxy.com/browse/BK-381)
**Status:** Candidate
**Components:** None
