# TEST: BK-38: TC01: should view all project Runs with row details and totals given authenticated workspace member

**Jira Key:** [BK-320](https://jira.upexgalaxy.com/browse/BK-320)
**Status:** Candidate
**Components:** None
