# TEST: BK-34: TC05: should create a separate Run for different start token given existing Run with token A

**Jira Key:** [BK-379](https://jira.upexgalaxy.com/browse/BK-379)
**Status:** Candidate
**Components:** None
