# TEST: BK-34: TC04: should return existing Run for same start token within 24 hours given existing Run

**Jira Key:** [BK-378](https://jira.upexgalaxy.com/browse/BK-378)
**Status:** Candidate
**Components:** None
