...
- executes: [BK-519](https://jira.upexgalaxy.com/browse/BK-519) - BK-337: TC01: should render the full header for a run-linked defect
...
- executes: [BK-523](https://jira.upexgalaxy.com/browse/BK-523) - BK-337: TC05: should show the Filed-manually notice and exactly six Details fields for a standalone defect
- executes: [BK-524](https://jira.upexgalaxy.com/browse/BK-524) - BK-337: TC06: should show the evidence count 6 of 10 with six rows
...
- executes: [BK-527](https://jira.upexgalaxy.com/browse/BK-527) - BK-337: TC09: should render a non-http evidence URL as inert text, never an anchor
- executes: [BK-528](https://jira.upexgalaxy.com/browse/BK-528) - BK-337: TC10: should offer zero editable fields and zero lifecycle controls to an admin-role member
- executes: [BK-529](https://jira.upexgalaxy.com/browse/BK-529) - BK-337: TC11: should navigate from the defects-list Bug cell to the detail record
...
- executes: [BK-532](https://jira.upexgalaxy.com/browse/BK-532) - BK-337: TC14: should answer 404 never 403 for a defect in a foreign workspace
...
- executes: [BK-534](https://jira.upexgalaxy.com/browse/BK-534) - BK-337: TC16: should answer 404 when the identifier is real but the URL names a different project
...
- executes: [BK-538](https://jira.upexgalaxy.com/browse/BK-538) - BK-337: TC20: should return 200 from GET bugs id matching the OpenAPI schema
...
- executes: [BK-540](https://jira.upexgalaxy.com/browse/BK-540) - BK-337: TC22: should render each status and severity with text plus colour, never colour alone
