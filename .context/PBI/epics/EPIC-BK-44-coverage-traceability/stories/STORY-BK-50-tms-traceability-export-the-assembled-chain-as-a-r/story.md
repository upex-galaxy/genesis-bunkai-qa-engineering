...
- [BK-329](https://jira.upexgalaxy.com/browse/BK-329): Coverage & Traceability API: traceability route ignores the {projectId} path segment — any well-formed UUID returns the story chain _(Cerrada)_
...
- [BK-330](https://jira.upexgalaxy.com/browse/BK-330): Traceability export: snapshot filename is minute-granular, so same-minute exports of one story collide _(Cerrada)_
