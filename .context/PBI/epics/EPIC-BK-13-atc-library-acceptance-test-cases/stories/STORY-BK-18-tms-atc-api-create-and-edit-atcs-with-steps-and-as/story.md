...
- [BK-96](https://jira.upexgalaxy.com/browse/BK-96): ATC Library: ATC PATCH API: Happy-path PATCH /atcs/{id} returns 412 instead of 200 though the edit commits _(Cerrada)_
...
- [BK-94](https://jira.upexgalaxy.com/browse/BK-94): [ATP] BK-18 — ATC create/edit REST API _(Listo)_
