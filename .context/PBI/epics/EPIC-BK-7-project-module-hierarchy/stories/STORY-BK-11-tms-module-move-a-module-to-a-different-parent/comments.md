...
## Ready For QA — [https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11](https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11) (Move a module to a different parent)

Merged to `staging` and deployed. Ready for testing on staging.

### Links

- PR: [https://github.com/upex-galaxy/upex-bunkai-tms/pull/11](https://github.com/upex-galaxy/upex-bunkai-tms/pull/11) (merged)
...
- [https://jira.upexgalaxy.com/browse/BK-57#icft=BK-57](https://jira.upexgalaxy.com/browse/BK-57#icft=BK-57): combining rename AND move in one API call is not atomic across the two steps (the UI performs them separately, so not triggered in the app).
...
# [https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11](https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11) — Acceptance Test Plan (ATP)

> ***Story:*** TMS-Module | Move a module to a different parent
***Epic:*** [https://jira.upexgalaxy.com/browse/BK-7#icft=BK-7](https://jira.upexgalaxy.com/browse/BK-7#icft=BK-7) (Project & Module Hierarchy)
...
| --- | --- |
| Environment | Staging |
| URL | [https://staging-upexbunkai.vercel.app](https://staging-upexbunkai.vercel.app/) |
| API Base | [https://staging-upexbunkai.vercel.app/api/v1](https://staging-upexbunkai.vercel.app/api/v1) |
...
[https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11](https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11) TEST RESULTS
Tested: 2026-06-15
...
SUMMARY
Completed full ATP execution for [https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11](https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11) (TMS-Module | Move a module to a different parent).
...
✅ QA PASSED — [https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11](https://jira.upexgalaxy.com/browse/BK-11#icft=BK-11) Module Move
