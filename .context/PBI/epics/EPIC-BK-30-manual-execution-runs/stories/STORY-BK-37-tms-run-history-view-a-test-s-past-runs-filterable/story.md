...
- [BK-249](https://jira.upexgalaxy.com/browse/BK-249): TECH-Security | Bind p_actor_user_id to auth.uid() across the bunkai_* explicit-actor RPCs _(Tareas por hacer)_
